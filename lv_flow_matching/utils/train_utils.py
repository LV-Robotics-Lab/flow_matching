...
from lv_flow_matching.infer.config_utils import (
    _MISSING,
    cfg_get,
    sync_fm_action_horizon_from_data,
)

# The placeholder expander needs the raising form, which cfg_get provides when
# no default is passed; keep the historical private name for that call site.
_get_by_path = cfg_get
