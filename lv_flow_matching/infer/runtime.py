...
from lv_flow_matching.infer.tensor import as_float32_array, default_tactile_norm, numpy_obs_to_torch
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        run_dir = Path(__file__).resolve().parents[2] / "outputs" / "chahua_eef_vision"
