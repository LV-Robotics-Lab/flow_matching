...
from lv_flow_matching.infer.config import load_run_config
from lv_flow_matching.infer.preprocess import build_dino_images
from lv_flow_matching.infer.runtime import FMInferenceRuntime
from lv_flow_matching.infer.tensor import as_float32_array, numpy_obs_to_torch
from lv_flow_matching.infer.types import PreprocessConfig
...
class ArchitectureOnlyRuntimeAdapter:
    ...
    def __init__(self, policy: FlowMatchingPolicy, device: torch.device, config: dict):
        ...
        self.memory_visual_history_length = 128
