...
```bash
python -m lv_flow_matching.tools.test_async_dino_memory --num-views 2
python -m lv_flow_matching.tools.test_async_dino_memory --num-views 3
python -m lv_flow_matching.tools.test_async_dino_history_window
python -m lv_flow_matching.tools.test_aligned_memory_training
```
